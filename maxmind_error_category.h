#ifndef MAXMIND_C_LIB_PRACTICE_MAXMIND_ERROR_CATEGORY_H
#define MAXMIND_C_LIB_PRACTICE_MAXMIND_ERROR_CATEGORY_H
...
template <>
struct is_error_code_enum<geo_ip_loader::MMDBStatus> : public true_type {};

} // namespace std


#endif //MAXMIND_C_LIB_PRACTICE_MAXMIND_ERROR_CATEGORY_H
